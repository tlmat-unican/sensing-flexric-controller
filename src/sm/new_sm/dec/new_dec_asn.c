...
new_event_trigger_t new_dec_event_trigger_asn(size_t len, uint8_t const buf[len])
{
  assert(0!=0 && "Not implemented");
  assert(buf != NULL);
  new_event_trigger_t avoid_warning;
...
new_action_def_t new_dec_action_def_asn(size_t len, uint8_t const action_def[len])
{
  ...
  new_action_def_t avoid_warning;
  return avoid_warning;
}
...
new_call_proc_id_t new_dec_call_proc_id_asn(size_t len, uint8_t const call_proc_id[len])
{
  ...
  new_call_proc_id_t avoid_warning;
  return avoid_warning;
}
